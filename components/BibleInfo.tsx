...
function GuidePanel({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      ...
      <p className="flex items-start gap-2 rounded-2xl border border-stone-200 bg-stone-50/70 p-3 text-[0.75rem] leading-relaxed text-stone-500 dark:border-stone-800 dark:bg-stone-900/50 dark:text-stone-400">
        <Sparkles className="mt-0.5 h-3.5 w-3.5 shrink-0 text-emerald-600 dark:text-emerald-400" strokeWidth={1.9} />
        <span>
          Decisions and analysis are generated by AI and can be incomplete or mistaken.
        </span>
      </p>
    </div>
  );
